...
// Optional: Set favorite to false for all existing documents in case some are missing the field
db.contacts.updateMany({}, { $set: { favorite: false } });
use("remix_contacts");
db.contacts.insertOne({
  avatar: "https://sessionize.com/image/test.jpg",
  first: "Test",
  last: "User",
  twitter: "@testuser",
});
